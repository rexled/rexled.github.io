 ...
 */
class ctBrandSliderItemShortcode extends ctShortcode {
	...
	public function getAttributes() {
		return array(
				...
				'imgsrc' => array('label' => __("source", 'ct_theme'), 'default' => '', 'type' => 'image', 'help' => __("Image", 'ct_theme'), 'help' => __('Every Brand Slider Item should be wrapped in Brand Slider element', 'ct_theme')),
...
new ctBrandSliderItemShortcode();