...
class ctVideoShortcode extends ctShortcode {
	...
	public function enqueueHeadScripts() {
		...
		wp_register_script('ct-fitvids', CT_THEME_ASSETS . '/js/bxslider/plugins/jquery.fitvids.js', array('jquery'),false,true);
	...
	public function handle($atts, $content = null) {
		...
		if ($m4v || $ogv) {
			...
			return
					...
					'<div id="jquery_jplayer_' . $id . '"  class="jp-jplayer" data-orig-width="' . $width . '" data-orig-height="' . $height . '"></div>
