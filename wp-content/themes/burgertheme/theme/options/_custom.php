...
$args['share_icons']['logo'] = array(
	...
	'img' => CT_THEME_SETTINGS_MAIN_DIR_URI . '/img/ct.png'
);
$args['share_icons']['docs'] = array(
	'link' => esc_url('http://createit.support/documentation/food-truck-documentation/'),
	'title' => __('Online documentation', 'ct_theme'),
	'style'=>'position:relative;top:-8px;left:15px'
);
